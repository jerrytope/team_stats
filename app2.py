...
# def create_player_plot(df, title):
#     player_column = df.columns[0]
#     assist_column = df.columns[1]
...
#         )
#     )
#     width=200,  # Set the figure width
#     height=600
...
# df1 = fetch_data('GAME1')
# df2 = fetch_data('GAME2')
# df3 = fetch_data('GAME3')
# df_assists = fetch_data('Assists')
# df_goal = fetch_data('Goals')
# df_sot = fetch_data('SOT')
# df_save = fetch_data('Save')  # Replace 'assist_sheet' with the actual name of the sheet
...
# # Create plot for player assists
# fig_assists = create_player_plot(df_assists, 'Player Assists')
# fig_goal = create_player_plot(df_goal, 'Player Goals')
# fig_sot = create_player_plot(df_sot, 'Player Shots On Target')
# fig_save = create_player_plot(df_save, 'Goalkeeper Save')
